...
class cube(object):  
    ...
    def draw(self, surface, eyes=False):  
        ...
        if eyes:  
            ...
            pygame.draw.circle(surface, (42, 0, 0), circleMiddle, radius)  
            pygame.draw.circle(surface, (0, 90, 0), circleMiddle2, radius)  
...
# It will add the new cube in snake tail after every successful score  
    def addCube(self):  
        ...
        if dx == 1 and dy == 0:  
            ...
            self.body.append(cube((tail.pos[0] + 12, tail.pos[1])))  
        elif dx == 0 and dy == 1:  
...
def main():  
    ...
    while flag:  
        ...
        if s.body[0].pos == snack.pos:  
            s.addCube()  
            snack = cube(randomSnack(rows, s), color=(32, 255, 0))  
